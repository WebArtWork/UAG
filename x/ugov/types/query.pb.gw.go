...
var (
	pattern_Query_Plan_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"uagd", "ugov", "v1", "plans", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Plans_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"uagd", "ugov", "v1", "plans"}, "", runtime.AssumeColonVerbOpt(false)))
)
